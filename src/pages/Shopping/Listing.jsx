...
function ShoppingListing() {
    ...
    console.log(productList, 'productListproductListproductListproductList')
    return (
            ...
            <div className='bg-background w-full rounded-lg shadow-sm'>
                <div className='p-4 border-b flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-3 '>
                        <span className='text-muted-foreground'>10 prod</span>
                        <DropdownMenu>
                                ...
                                <DropdownMenuRadioGroup value={sort} onValueChange={handleSort}>
                                    {
                                        sortOptions.map(sortItem => <DropdownMenuRadioItem
                                            value={sortItem.id} key={sortItem.id}>{
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4'>
                    {productList && productList.length > 0 ?
                        productList.map(productItem => <ShoppingProductTile
                            ...
                            product={productItem} handleAddToCart={handleAddToCart}></ShoppingProductTile>) : null}
                </div>
            </div>
