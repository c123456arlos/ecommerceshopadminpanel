...
//     // console.log(cartItems, 'object cart items')
//     console.log(currentSelectedAddress, 'items cart card')
...
//                 <img src={img} className='h-full w-full object-cover object-center'></img>
//             </div>
//             <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5 p-5'>
//                 <Address setCurrentSelectedAddress={setCurrentSelectedAddress}></Address>
//                 <div className='flex flex-col gap-4'>
//                     {cartItems && cartItems.items && cartItems.items.length > 0 ?
//                         cartItems.items.map(item => <UserCartItemsContent cartItem={item}></UserCartItemsContent>) : null}
